...
<p align="center">
  <img src="docs/assets/brand/icon.png" alt="CryptoMako icon" width="128"/>
</p>
...
Canonical mark (all platforms): [`docs/assets/brand/`](docs/assets/brand/) — app icons, menu-bar / tray templates, Linux desktop, favicon, and README hero. Sibling iOS/Android apps should reuse this pack.
