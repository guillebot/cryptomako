...
Write-Host "Publishing Desktop -> $deskOut"
dotnet publish src/CryptoMako.Desktop -c $Configuration -r $rid --self-contained:$sc -p:PublishSingleFile=false -o $deskOut
